<!--
  The shape every Plinth release takes. The workflow attaches this file as the
...
macOS 26. Plinth reads the real Dock's own preferences and draws against the
...
1. Unzip and move **Plinth.app** to your Applications folder. Do this before
   the next step — the permission you are about to grant is attached to where
   the app lives.
...
3. Open **System Settings ▸ Privacy & Security** and scroll to **Security**.
   There is a line there about Plinth being blocked, with an **Open Anyway**
   button. Click it and authenticate.
4. Launch Plinth again and confirm **Open Anyway**.
...
Plinth is an accessory app: no Dock tile, no entry in the app switcher, no
...
Nothing is sent anywhere. Plinth is not sandboxed because reading the Dock's
...
Plinth exists because of [**Dockset**](https://dockset.app), a genuinely
lovely macOS app by an independent developer, who had the idea of a widget
shelf beside the Dock and executed it beautifully. Plinth is an independent
